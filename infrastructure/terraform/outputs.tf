...
output "pipeline_name" {
  ...
  value       = var.enable_cicd_pipeline ? module.cicd_pipeline[0].pipeline_name : null
}

output "pipeline_arn" {
  description = "ARN of the CodePipeline (if enabled)"
  value       = var.enable_cicd_pipeline ? module.cicd_pipeline[0].pipeline_arn : null
}

output "codebuild_project_name" {
  description = "Name of the CodeBuild project (if enabled)"
  value       = var.enable_cicd_pipeline ? module.cicd_pipeline[0].codebuild_project_name : null
}

output "pipeline_artifacts_bucket" {
  description = "S3 bucket for pipeline artifacts (if enabled)"
  value       = var.enable_cicd_pipeline ? module.cicd_pipeline[0].artifacts_bucket_name : null
}
